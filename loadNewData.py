...
class VISTDataset(Dataset):
    def __init__(self, opt):
        ...
        self.story_line['test'] = {A: N for (A, N) in [x for x in self.story_line['test'].items()][:100]}
        self.story_line['image2caption']['test'] = {A: N for (A, N) in [x for x in self.story_line['image2caption']['test'].items()][:100]}

        self.story_line['image2caption_original']['test'] = {A: N for (A, N) in [x for x in self.story_line['image2caption_original']['test'].items()][:100]}
        self.story_line['album2stories']['test'] = {A: N for (A, N) in [x for x in self.story_line['album2stories']['test'].items()][:100]}
